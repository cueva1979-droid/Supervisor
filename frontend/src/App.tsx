...
const navItems: (NavItem & { children?: NavItem[] })[] = [
  ...
  { id: 'pac-dashboard', label: 'Plan Anual de Contratación', icon: FileText,
    children: [
      { id: 'pac-dashboard', label: 'Panel Plan Anual de Contratación', icon: LayoutDashboard, parent: 'pac' },
...
const pageTitles: Record<string, string> = {
  ...
  'users': 'Usuarios',
  'pac-dashboard': 'Plan Anual de Contratación - Panel Principal',
  'pac-upload': 'Plan Anual de Contratación - Cargar Archivos',
  'pac-table': 'Plan Anual de Contratación - Tabla de Datos',
  'pac-analisis': 'Plan Anual de Contratación - Análisis de Períodos',
  'pac-cert': 'Plan Anual de Contratación - Certificados',
  'pac-cert-generate': 'Plan Anual de Contratación - Generar Certificado',
  'pac-cert-manual': 'Plan Anual de Contratación - Certificación Manual',
  'pac-cert-verificacion': 'Plan Anual de Contratación - Verificación Catálogo',
  'pac-cpc': 'Panel CPC',
